...
public interface EmployeeDao {
	...
	// 根据参数动态查询员工 fetchType表示查询类型是立即加载（EAGER）还是懒加载（LAZY）
	//one表示一个一对一关联关系 many=@Many(select="",fetchType="")属性是一个集合，一对多
	//column="card_id",property="cardId"表示Employee的cardId属性对应表里的card_id列
	//如果列和属性相同，则可以省略@Result注解，MyBatis会自动映射
